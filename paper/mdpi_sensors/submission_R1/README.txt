...
response_to_editor.*       Reply to the Academic Editor's comment asking that
                           ...
                           (54 refs audited; one preprint replaced by its
                           published SOSA 2025 version; 51/51 DOIs verified;
                           one wrong DOI corrected) plus a 2026-08-16
                           re-verification across registries, 2026 venue
                           accepted-lists and author pages; explains why the
                           one remaining preprint is the framework the paper
                           studies and cannot be substituted without
                           misattribution; and records the changes made in
                           response: citations of it reduced 8 -> 6, a status
                           footnote at first citation, and a new published
